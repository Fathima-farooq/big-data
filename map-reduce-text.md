...
bsau@bsau-V530-15ICB:~/hadoop-2.9.1/bin$ hdfs dfs -touchz /sam /s1.txt
bsau@bsau-V530-15ICB:~/hadoop-2.9.1/bin$ cat > s1.txt
boy doy soy roy doy
^Z
[2]+  Stopped                 cat > s1.txt
bsau@bsau-V530-15ICB:~/hadoop-2.9.1/bin$ cat s1.txt
boy doy soy roy doy
...
if current_word == word:
    print ('%s\t%s' % (current_word, current_count))
---------------------------------------------------------------------
bsau@bsau-V530-15ICB:~/hadoop-2.9.1/bin$ pwd s1.txt
/home/bsau/hadoop-2.9.1/bin
bsau@bsau-V530-15ICB:~/hadoop-2.9.1/bin$ cat /home/bsau/hadoop-2.9.1/bin/s1.txt | python3 map.py | sort | python3 red.py
boy	1
doy	2
roy	1
soy	1
